...
/**
 * Class FME_Mediaappearance_Helper_Image
 *
 * @category FME
 * @package  Mediaappearance
 * @author   Altaf Ahmed <support@fmeextension.com>
...
class FME_Mediaappearance_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('mediaappearance/image'));

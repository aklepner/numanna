...
/**
 * Class FME_Mediaappearance_Model_Image
 *
 * @category FME
 * @package  Mediaappearance
 * @author   Altaf Ahmed <support@fmeextension.com>
...
class FME_Mediaappearance_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'TVAppearance'.DS.'cache'.DS;

...
/**
 * Class FME_Mediaappearance_Block_Adminhtml_Videoblocks
 *
 * @category FME
 * @package  Mediaappearance
 * @author   Altaf Ahmed <support@fmeextension.com>
...
class FME_Mediaappearance_Block_Adminhtml_Videoblocks extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_addButtonLabel = Mage::helper('mediaappearance')->__('Add Media Block');
        parent::__construct();
    }
}

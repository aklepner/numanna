...
class HN_Zohointegration_Model_Observer {
	...
	{
		$this->_account = Mage::getModel('zohointegration/sync_account');
	...
	/**
	 * Create Lead when customer register success
	 *
	...
	/**
	 * Update Lead, Contact, Account when customer edit information
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Delete Lead, Contact, Account when customer edit information
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Update Campaign when admin edit Catalog Rule Price
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Create new Sales Order when customer checkout
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Update Product when admin edit or create new
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Delete Product when admin deleted Product
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Create Lead when customer register newsletter
	 *
	 * @param Varien_Event_Observer $observer
	 */
	...
	/**
	 * Create Invoice when invoice created
	 *
	 * @param Varien_Event_Observer $observer
	 */
